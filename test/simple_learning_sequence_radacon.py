...
from sili.modules.radacon.radacon import Radacon
...
if __name__ == "__main__":
    ...
    depth_pyr_conv = DepthPyrConv(gpu, im_pyr.out_pyr, ones, backprop_conv=True)
    depth_pyr_conv_optim = Radacon(gpu,
    ...
    runner = GPUMLPipeline(
        ...
        input_buffers=im_pyr.forward_input_buffers + [depth_pyr_conv_optim.rand_seed_time_buff],
#        output_buffers=depth_pyr_conv.forward_output_buffers
    ...
    while not d.window.is_closing:
        depth_pyr_conv_optim.set_time_seed()
